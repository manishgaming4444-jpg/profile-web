...
app.get('/dashboard', isLoggedIn, async (req, res) => {
    try {
        ...
        const html = dashTemplate
            ...
            .replace(/\{\{MUSIC_YES_BG\}\}/g,            isMusicOn ? 'rgba(34,197,94,0.9)' : 'transparent')
            .replace(/\{\{MUSIC_YES_BORDER\}\}/g,        isMusicOn ? '#22c55e' : 'transparent')
            .replace(/\{\{MUSIC_YES_COLOR\}\}/g,         isMusicOn ? '#fff' : 'rgba(255,255,255,0.3)')
            .replace(/\{\{MUSIC_NO_BG\}\}/g,             !isMusicOn ? 'rgba(255,255,255,0.12)' : 'transparent')
            .replace(/\{\{MUSIC_NO_BORDER\}\}/g,         'transparent')
            .replace(/\{\{MUSIC_NO_COLOR\}\}/g,          !isMusicOn ? 'rgba(255,255,255,0.85)' : 'rgba(255,255,255,0.25)')
